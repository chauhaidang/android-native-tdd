...
public class DialerActivity extends Activity {
    ...
    public void onPickContact(View view) {
        final Intent pickContactIntent = new Intent(this, com.example.android.testing.espresso.BasicSample.ContactsActivity.class);
        ...
        if (requestCode == REQUEST_CODE_PICK) {
            if (resultCode == RESULT_OK) {
                mCallerNumber.setText(data.getExtras()
                        .getString(com.example.android.testing.espresso.BasicSample.ContactsActivity.KEY_PHONE_NUMBER));
            }
        }
    }
}